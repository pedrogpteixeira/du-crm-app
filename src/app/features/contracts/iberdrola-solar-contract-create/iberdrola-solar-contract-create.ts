...
export class IberdrolaSolarContractCreate implements OnInit {
  ...
  contractForm = {
    ...
    contratacao: 'Contratação Digital' as IberdrolaSolarContratacao,

    tipoSegmento: 'Residencial' as IberdrolaSolarTipoSegmento,

    tipoProduto: 'Painéis Solares' as IberdrolaSolarTipoProduto,
    ...
    estado: 'Pedido de Proposta' as IberdrolaSolarContractStatus,
    ...
    metodoPagamento: 'Pronto Pagamento' as IberdrolaSolarMetodoPagamento,
      ...
      .subscribe({
        ...
        error: (error) => {
          this.errorMessage =
            ...
            error?.error?.message ||
            'Não foi possível criar o contrato Iberdrola Solar.';
        },
