...
export class GalpPowerGasContractCreate implements OnInit {
  ...
  contractForm = {
    ...
    estado: 'Pedido de chamada' as GalpPowerGasContractStatus,
  ...
  private resolveContractTeams(): GalpPowerGasContractTeamVisibility[] {
  ...
  private loadCampaigns(): void {
    this.campaignService
      .getCampaignsByCompanyId(environment.GALP_POWER_GAS_COMPANY_ID)
  ...
  createContract(): void {
    ...
    let createdContract: GalpPowerGasContractDetail | null = null;
    ...
    this.galpPowerGasContractService
      ...
      .subscribe({
        next: (contract) => {
          ...
          this.router.navigate(['/home/contracts/galp-power-gas', contract.id]);
        },
  ...
  private buildContractPayload(): CreateGalpPowerGasContractRequest {
    if (!this.client) {
      throw new Error('Cliente não identificado.');
    }

    const estado: GalpPowerGasContractStatus = this.estadoOptions[0];

    const payload: CreateGalpPowerGasContractRequest = {
  ...
  private addLightRegistrationFields(payload: CreateGalpPowerGasContractRequest): void {
  ...
  private addSharedFields(payload: CreateGalpPowerGasContractRequest): void {
  ...
  private addProFields(payload: CreateGalpPowerGasContractRequest): void {
    if (this.shouldShowLuzFields()) {
